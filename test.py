...
label = ttk.Label(text="СУПЕР-ПУПЕР ПРОГРАММА СДЕЛАНА МНОЮ",font=("Arial",32), background="#FFCDD2", foreground="#B71C1C", padding=8)
